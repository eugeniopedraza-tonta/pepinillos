...
export function CartDrawer() {
  const { items, cartOpen, setCartOpen, removeItem, updateQuantity, subtotal, checkoutUrl, canCheckoutWithShopify } =
    useCart();
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-[var(--brand-olive)]/8 px-6 py-5">
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-[var(--brand-earth)]">Tu pedido</p>
        ...
        <div className="border-t border-[var(--brand-olive)]/8 px-6 py-5">
          <div className="rounded-[24px] bg-[var(--brand-olive)] p-5 text-[var(--brand-cream)]">
            ...
            >
              {canCheckoutWithShopify ? "Ir al checkout seguro" : "Finalizar por WhatsApp"}
            </a>
          </div>
        </div>
      </aside>
